...
async function getRequest(requestID) {
    try {
        const request = await requests_1.default.findOne({ _id: requestID });
...
async function getRequests(ownerDocID) {
    try {
        const requestData = await requests_1.default.aggregate([
...
async function addRequest(reqdata) {
    try {
        const requestDocument = await requests_1.default.create(reqdata);
